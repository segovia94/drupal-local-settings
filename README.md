...
4. Run `lando drupal-download` to download drupal via Composer.

5. Run `lando drupal-local-settings`. This will pull in the local settings files into your site.

6. Install a fresh site with `lando drupal-install`.
